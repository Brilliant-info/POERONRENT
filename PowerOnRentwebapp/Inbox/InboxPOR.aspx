<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    CodeBehind="InboxPOR.aspx.cs" Inherits="PowerOnRentwebapp.Inbox.InboxPOR" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
            ...
            <div>
                <obout:Grid ID="GVInboxPOR" runat="server" Width="100%" AllowColumnReordering="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column DataField="ReferenceId" HeaderText="" Width="0%" Visible="false">
                        </obout:Column>
                        ...
                        <obout:Column DataField="Site" HeaderText="Site" Wrap="true" Width="10%">
                        </obout:Column>
    ...
    <script type="text/javascript">
        ...
        function selectedRecForView() {
            ...
            if (GVInboxPOR.SelectedRecords.length > 0) {

                for (var i = 0; i < GVInboxPOR.SelectedRecords.length; i++) {
                    var record = GVInboxPOR.SelectedRecords[i];
