<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_AttachDocument.ascx.cs"
    Inherits="PowerOnRentwebapp.Document.UC_AttachDocument" %>
    ...
    <table class="gridFrame" width="100%">
        <tr>
            <td style="text-align: left;">
                <a class="headerText">Document List</a>
            </td>
            <td>
                <input type="button" id="btnDocumentAdd" value="Add New" onclick="openDocumentWindow('0')"
                    style="float: right;" />
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <obout:Grid ID="GvDocument" runat="server" AutoGenerateColumns="false" AllowFiltering="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="Delete" DataField="DeleteAccess" HeaderText="Delete" Width="5%"
                        ...
                        <obout:Column DataField="DocumentName" HeaderText="Document Title" Width="20%" Wrap="true">
                        </obout:Column>
                        ...
                        <obout:Column DataField="FileType" HeaderText="Document Type" Width="10%" Align="center"
                            HeaderAlign="right">
                        </obout:Column>
