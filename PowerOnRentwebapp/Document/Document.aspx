F<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Document.aspx.cs" Inherits="PowerOnRentwebapp.Document.Document" %>
...
<body>
    ...
    <div>
        <asp:HiddenField ID="hdDownLoadAccessIDs" runat="server" ViewStateMode="Enabled"
            ClientIDMode="Static" />
                    ...
                    <td style="width: 20%">
                        <table style="float: right;">
                            <tr>
                                ...
                                <td>
                                    <input type="button" id="btnDocumentClear" value="Clear" onclick="ClearMode('divDocument');" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="width: 20%">
                        <table style="float: right;">
                            <tr>
                                ...
                                <td>
                                    <input type="button" id="btnDocumentClear2" value="Clear" onclick="ClearMode('divDocument');" />
                                </td>
                            </tr>
                        </table>
                    </td>
