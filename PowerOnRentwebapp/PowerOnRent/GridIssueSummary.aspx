<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridIssueSummary.aspx.cs"
    Inherits="PowerOnRentwebapp.PowerOnRent.GridIssueSummary" EnableEventValidation="false" %>
                    ...
                    <td>
                        <obout:Grid ID="GVIssue" runat="server" AllowAddingRecords="false" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <obout:Column DataField="IssueStatus" HeaderText="Issue Status" HeaderAlign="left"
                                    Align="left" Width="9%">
                                </obout:Column>
