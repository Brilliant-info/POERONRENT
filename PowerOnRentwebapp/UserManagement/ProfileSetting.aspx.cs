...
namespace PowerOnRentwebapp.UserManagement
{
    public partial class ProfileSetting : System.Web.UI.Page
    {
        ...
        {
            UserCreationService.iUserCreationClient userClient = new UserCreationService.iUserCreationClient();
            try
            {
                CustomProfile profile = CustomProfile.GetProfile();
                
                UserCreationService.vGetUserProfileByUserID objuser = new UserCreationService.vGetUserProfileByUserID();
