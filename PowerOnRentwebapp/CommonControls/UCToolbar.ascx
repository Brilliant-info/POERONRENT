<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCToolbar.ascx.cs" Inherits="PowerOnRentwebapp.CommonControls.UCToolbar" %>
        ...
        <tr>
            <td class="tdWidth">
                <asp:Button ID="btnAddNew" runat="server" Text="Add New" ToolTip="Add New" OnClick="ImgbtnAddNew_Click"
                    CausesValidation="false" Height="24px" Width="65px" CssClass="FixWidth" ClientIDMode="Static" />
            </td>
            ...
            <td class="tdWidth">
                <asp:Button ID="btnExport" runat="server" Text="Export" ToolTip="Export" CausesValidation="false" ClientIDMode="Static" 
                    CssClass="FixWidth" />
            </td>
            <td class="tdWidth">
                <asp:Button ID="btnImport" runat="server" Text="Import" ToolTip="Import" OnClick="ImgbtnImport_Click" ClientIDMode="Static" 
                    CausesValidation="false" CssClass="FixWidth" />
            </td>
            <td class="tdWidth">
                <asp:Button ID="btmMail" runat="server" Text="Mail" ToolTip="Mail" CausesValidation="false" ClientIDMode="Static" 
                    CssClass="FixWidth" />
            </td>
            <td class="tdWidth">
                <asp:Button ID="btnPrint" runat="server" Text="Print" CausesValidation="false" ToolTip="Print" ClientIDMode="Static" 
            ...
            <td style="width: 74px;" runat="server" id="tdConvertTo">
                <input type="button" value="Convert To" id="btnConvertTo" onclick="fillConvertTo()"
                    class="FixWidth" />
            </td>
            <td>
                <%--<asp:Button ID="btnHelp" runat="server" Text="Help" ToolTip="Help" CausesValidation="false"
                CssClass="help" />--%>
