<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Toolbar.ascx.cs" Inherits="PowerOnRentwebapp.CommonControls.Toolbar" %>
<div id="dvbtn">
    ...
    <table style="margin-top: 0px; float: right;" id="tabletoolbar">
        <tr>
            ...
            <td>
                <input type="button" value="Export" runat="server" id="btnExport" class="Off buttonON"
                    clientidmode="Static" causesvalidation="false" />
            </td>
            <td>
                <input type="button" value="Import" runat="server" id="btnImport" class="Off buttonON"
                    clientidmode="Static" causesvalidation="false" />
            </td>
            <td>
                <input type="button" value="Mail" runat="server" id="btnMail" title="Not-Allowed"
                    class="Off buttonON" clientidmode="Static" causesvalidation="false" />
            </td>
            <td>
                <input type="button" value="Print" runat="server" id="btnPrint" title="Not-Allowed"
                    class="Off buttonON" clientidmode="Static" causesvalidation="false" />
            </td>
            <td runat="server" id="tdConvertTo">
                <input type="button" value="ConvertTo" runat="server" id="btnConvertTo" title="Not-Allowed"
                    class="Off buttonON" clientidmode="Static" causesvalidation="false" />
            </td>
            <td>
